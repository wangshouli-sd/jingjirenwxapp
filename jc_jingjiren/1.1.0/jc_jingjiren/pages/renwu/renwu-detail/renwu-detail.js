...
>>>>>>> e30a7e9d0d410bbbe724fdff64a3300072c23674
        that.setData({
            yongjin: app.globalData.yongjin
        })
        console.log(options)
        ...
        // 获取任务详情信息
        wx.request({
            url: app.siteInfo.siteroot + '?i=' + app.siteInfo.uniacid + '&c=entry&a=wxapp&do=index&m=jc_jingjiren&r=fr-project/one',
            method: 'get',
            data: {
                openid: app.globalData.openid,
                id: id
...
<<<<<<< HEAD
    ...
    makeCollectionChange: function (e) {
        ...
        wx.request({
            url: app.siteInfo.siteroot + '?i=' + app.siteInfo.uniacid + '&c=entry&a=wxapp&do=index&m=jc_jingjiren&r=fr-member/likes',
            method: 'get',
            data: {
                project_id: id,
                openid: app.globalData.openid
